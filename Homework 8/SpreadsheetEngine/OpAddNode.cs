// <copyright file="OpAddNode.cs" company="PlaceholderCompany">
...
namespace SpreadsheetEngine
{
    ...
    /// </summary>
    public class OpAddNode : OperatorNode
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpAddNode"/> class.
        /// </summary>
        /// <param name="left">Left subtree.</param>
        /// <param name="right">Right subtree.</param>
        public OpAddNode(ExpressionTreeNode left, ExpressionTreeNode right)
            : base(left, right)
        {
        }
