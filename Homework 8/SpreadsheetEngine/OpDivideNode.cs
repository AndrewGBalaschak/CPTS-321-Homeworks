// <copyright file="OpDivideNode.cs" company="PlaceholderCompany">
...
namespace SpreadsheetEngine
{
    ...
    /// </summary>
    public class OpDivideNode : OperatorNode
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpDivideNode"/> class.
        /// </summary>
        /// <param name="left">Left subtree.</param>
        /// <param name="right">Right subtree.</param>
        public OpDivideNode(ExpressionTreeNode left, ExpressionTreeNode right)
            : base(left, right)
        {
        }
